...
TOPICS: dict[str, tuple[str, tuple[str, ...]]] = {
    ...
    "digital_advertising": ("business_model", (r"advertis", r"ad impression", r"advertiser", r"ad revenue")),
    ...
    "antitrust_regulation": ("risk", (r"antitrust", r"competition law", r"anti-competitive", r"regulatory investigation")),
